package com.sedmelluq.lavaplayer.source.iheart;
...
public class iHeartAudioTrack extends DelegatedAudioTrack {
    ...
    private String getRequestUrl() {
        if (trackInfo.isStream) return String.format(RADIO_ID_API_URL, trackInfo.identifier);
        else return String.format(EPISODE_API_URL, trackInfo.identifier);
    }
