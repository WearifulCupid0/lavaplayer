...
public class MixcloudM3uAudioTrack extends DelegatedAudioTrack {
    private static final Logger log = LoggerFactory.getLogger(MixcloudM3uAudioTrack.class);
    ...
    public MixcloudM3uAudioTrack(AudioTrackInfo trackInfo, HttpInterface httpInterface, String playbackUrl) {
        super(trackInfo);
    ...
    private SegmentTracker createSegmentTracker() throws IOException {
        ...
        tracker.setupDecoder(MixcloudMpegSegmentDecoder::new);
        return tracker;
    }
    ...
    private class SegmentTracker implements AutoCloseable {
        ...
        private MixcloudSegmentDecoder decoder;
        ...
        private void setupDecoder(MixcloudSegmentDecoder.Factory factory) {
