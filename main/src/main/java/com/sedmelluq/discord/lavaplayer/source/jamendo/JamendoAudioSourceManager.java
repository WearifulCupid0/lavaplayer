...
public class JamendoAudioSourceManager implements AudioSourceManager, HttpConfigurable {
    private static final String URL_REGEX = "^https?://www\\.jamendo\\.com/([a-zA-Z0-9-_]+)/([0-9]+)$";
    private static final String SHORT_URL_REGEX = "^https?://www\\.jamen\\.do/([a-zA-Z0-9-_]+)/([0-9]+)$";
