...
/**
 * Audio track that handles processing Bandlab tracks.
 */
public class BandlabAudioTrack extends DelegatedAudioTrack {
    private static final Logger log = LoggerFactory.getLogger(BandlabAudioTrack.class);
    ...
    */
    ...
    public void process(LocalAudioTrackExecutor localExecutor) throws Exception {
        try (HttpInterface httpInterface = sourceManager.getHttpInterface()) {
            String trackMediaUrl = String.format("https://static.bandlab.com/revisions-formatted/%s/%s.m4a", trackInfo.identifier, trackInfo.identifier);
            log.debug("Starting Bandlab track from URL: {}", trackMediaUrl);
