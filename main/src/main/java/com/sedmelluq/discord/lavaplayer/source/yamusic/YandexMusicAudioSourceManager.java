...
public class YandexMusicAudioSourceManager implements AudioSourceManager, HttpConfigurable {
  private static final String TRACK_URL_REGEX = "^https?://music\\.yandex\\.[a-zA-Z]+/album/([0-9-_]+)/track/([0-9-_]+)(?:\\?.*|)$";
  private static final String ALBUM_URL_REGEX = "^https?://music\\.yandex\\.[a-zA-Z]+/album/([0-9-_]+)(?:\\?.*|)$";
  private static final String PLAYLIST_URL_REGEX = "^https?://music\\.yandex\\.[a-zA-Z]+/users/(.+)/playlists/([0-9-_]+)(?:\\?.*|)$";
  private static final String ARTIST_URL_REGEX = "^https?://music\\.yandex\\.[a-zA-Z]+/artist/([0-9-_]+)(?:\\?.*|)$";
