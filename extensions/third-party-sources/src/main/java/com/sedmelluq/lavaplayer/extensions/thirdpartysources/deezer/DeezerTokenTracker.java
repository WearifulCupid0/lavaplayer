...
public class DeezerTokenTracker {
    ...
    private void refreshSession() throws IOException {
        try (HttpInterface httpInterface = sourceManager.getHttpInterface()) {
            ...
            HttpPost getUserToken = new HttpPost(DeezerConstants.AJAX_URL + "?method=deezer.getUserData&input=3&api_version=1.0&api_token=");
            JsonBrowser json = DeezerAudioSourceManager.fetchResponseAsJson(httpInterface, getUserToken);
